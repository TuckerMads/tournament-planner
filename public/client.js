...
document.addEventListener('DOMContentLoaded', function () {
    ...
    joinForm === null || joinForm === void 0 ? void 0 : joinForm.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
        var name, passcode, response, tournament;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("/api/tournaments/by-passcode?name=".concat(encodeURIComponent(name), "&passcode=").concat(encodeURIComponent(passcode)))];
                case 1:
                    response = _a.sent();
